...
const DashboardErrorPage = () => {
  ...
  return (
    <>
      <title>SkilledHub || Dashboard Error-404</title>
      ...
      <MyContainer>
        ...
        >
          ...
          <div>
            <Link to={"/"}>
              <button
                className="btn bg-linear-to-r from-[#128d3b] to-[#04b956] text-white px-6 
              hover:shadow-[2px_4px_6px_rgba(78,77,77,0.5),-2px_-4px_6px_rgba(65,64,64,0.6)]
              hover:bg-linear-to-r hover:from-[#FFB703] hover:to-[#06857a]
            ...
            <button
            onClick={() => navigate(-1)}
              className="btn bg-linear-to-r from-[#078b64] to-[#09cddb] text-white px-6 
              hover:shadow-[2px_4px_6px_rgba(78,77,77,0.5),-2px_-4px_6px_rgba(65,64,64,0.6)]
              hover:bg-linear-to-r hover:from-[#FFB703] hover:to-[#0daf71]
