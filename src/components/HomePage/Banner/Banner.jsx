        ...
        >
          ...
          >
            <MyContainer>
              ...
              >
                {/* Text */}
                <div className="flex-1 text-center lg:text-left md:text-center lg:ml-4">
                  ...
                  <div className="flex justify-center lg:justify-start gap-4 flex-wrap lg:mb-0 md:mb-0 mb-4">
                ...
                <div className="flex-1 flex justify-center">
                  <img
                    ...
                    alt="banner"
                    className="w-3/4 lg:w-full lg:max-h-[52vh] object-contain rounded-xl md:max-h-[40vh] max-h-40"
                  />
                </div>
              </div>
            </MyContainer>
